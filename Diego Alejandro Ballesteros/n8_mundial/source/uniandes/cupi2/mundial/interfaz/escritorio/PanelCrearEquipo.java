...
public class PanelCrearEquipo extends JPanel implements ActionListener
{
    ...
    /**
     * El comando para el bot Crear
     */
    private static final String CREAR_EQUIPO = "CrearEquipo";

    /**
     * El comando para el bot Cancelar
     */
    private static final String CANCELAR = "Cancelar";

    /**
     * El comando para el bot Explorar
     */
    ...
    /**
     * Es el campo de texto para ingresar el director ténico del equipo
     */
    ...
    /**
     * Es el bot usado para buscar la imagen
     */
    private JButton botonExplorar;

    /**
     * Es el bot que sirve para agregar un nuevo equipo
     */
    private JButton botonAgregarEquipo;

    /**
     * Es el bot que sirve para cerrar el di疝ogo sin guardar los cambios
     */
    ...
    public PanelCrearEquipo( DialogoCrearEquipo d )
    {
        ...
        etiquetaDirector = new JLabel( "Director Ténico: " );
        gbc.gridx = 0;
        gbc.gridy = 1;
    ...
    /**
     * Da el valor del campo de texto con el pa﨎 del equipo
     * @return Se retorn� el nombre del pa﨎 ingresado por el usuario
     */
    ...
    /**
     * Da el valor del campo de texto con el director t馗nico del equipo
     * @return Se retorn� el nombre del director ingresado por el usuario
     */
     ...
     * @return Se retorn� la ruta de la imagen ingresada por el usuario
     */
    ...
    /**
     * Ejecuta una acci cuando se hace click sobre un bot
     * @param evento el evento del click sobre un bot - evento!=null
     */
