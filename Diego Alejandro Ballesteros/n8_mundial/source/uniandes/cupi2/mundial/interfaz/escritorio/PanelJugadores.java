...
public class PanelJugadores extends JPanel implements ActionListener
{
    ...
    /**
     * Es la etiqueta con la posici del jugador
     */
     ...
     */
    public PanelJugadores( Controlador controlador)
    {
    ...
    public void cambiarJugador( Jugador j )
    {
        ...
        etiquetaValorEdad.setText( Integer.toString( jugador.darEdad( ) ) + " as" );
    ...
    /**
     * Cambia el equipo para el cual se muestran los jugadores en el panel y actualiza la informaci mostrada
    ...
    /**
     * Ejecuta las acciones asociadas a los eventos. Actualiza la informaci del jugador en el panel de acuerdo al jugador seleccionado en el comboBox
     * @param evento Es el evento del click sobre un bot - evento!=null
     */
    public void actionPerformed( ActionEvent evento )
    {
        ...
        if( CAMBIAR_JUGADOR.equals( comando ) )
        {
            ...
            principal.switchSelectedPlayer( nombreJugador );
