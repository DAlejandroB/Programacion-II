...
/**
 * Es el di疝ogo para crear un nuevo jugador
 */
public class DialogoCrearJugador extends JDialog
{
    ...
    /**
     * Centra el di疝ogo en la pantalla
     */
    ...
    public void crearJugador( )
    {
        ...
        else
        {
            try
            {
                ...
                {
                    parametersOk = false;
                    JOptionPane.showMessageDialog( this, "La edad ingresada no es un valor v疝ido", "error", JOptionPane.ERROR_MESSAGE );
                }
                else
                {
                    ...
                    {
                        parametersOk = false;
                        JOptionPane.showMessageDialog( this, "La posici ingresada no es un valor v疝ido", "error", JOptionPane.ERROR_MESSAGE );
                    }
                    else
                    {
                        try
                        {
                            ...
                            {
                                parametersOk = false;
                                JOptionPane.showMessageDialog( this, "La altura ingresada no es un valor v疝ido", "error", JOptionPane.ERROR_MESSAGE );
                            }
                            else
                            {
                                try
                                {
                                    ...
                                    {
                                        parametersOk = false;
                                        JOptionPane.showMessageDialog( this, "El peso ingresado no es un valor v疝ido", "error", JOptionPane.ERROR_MESSAGE );
                                    }
                                    else
                                    {
                                        try
                                        {
                                            ...
                                            {
                                                parametersOk = false;
                                                JOptionPane.showMessageDialog( this, "El salario ingresado no es un valor v疝ido", "error", JOptionPane.ERROR_MESSAGE );
                                            }
                                            else
                                            {
                                                try
                                                {
                                                    ...
                                                    {
                                                        parametersOk = false;
                                                        JOptionPane.showMessageDialog( this, "La ruta de la imagen ingresada no es un valor v疝ido", "error", JOptionPane.ERROR_MESSAGE );
                                                    }
                                                }
